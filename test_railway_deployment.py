#!/usr/bin/env python3
"""
Script de pruebas para despliegue en Railway
...
class RailwayDeploymentTester:
    """Tester para despliegue en Railway"""
    ...
    def test_performance(self) -> bool:
        ...
        if avg_time < 5.0 and max_time < 10.0:
            ...
            logger.warning("⚠️  Rendimiento por debajo del umbral esperado")
            self.test_results['performance'] = False
            return False

    def run_all_tests(self) -> Dict[str, Any]:
        """Ejecutar todas las pruebas"""
        logger.info("🚀 Iniciando pruebas de despliegue en Railway...")
